...
public class Window_1_2 extends Frame {
	...
	Color[] color = {(new Color(199,198,255)),(new Color(185,186,255)),(new Color(174,173,255)),(new Color(164,163,255)),(new Color(154,153,255)),(new Color(144,143,255)),(new Color(134,133,255)),(new Color(124,123,255)),(new Color(114,113,255)),(new Color(104,103,255))};
